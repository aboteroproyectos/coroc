...
export interface CorocEvent {
  type: 'payment.posted' | 'payment.reversed' | 'loan.created' | 'client.updated' | 'dashboard.changed' | 'security.lockout' | 'document.created' | 'task.finished' | 'intake.updated' | 'message.updated' | 'whatsapp.suspended';
  tenantId: string;
