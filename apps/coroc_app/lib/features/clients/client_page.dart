          ...
          return DefaultTabController(
            ...
            child: NestedScrollView(
              headerSliverBuilder: (context, _) => [
                SliverToBoxAdapter(
                  child: _Header(client: c, loan: loan, onSelectLoan: (id) => setState(() => _loanId = id)),
                ),
    ...
    return ColoredBox(
      ...
      child: TabBar(
        ...
        tabs: [
          ...
          Tab(text: l.tabSchedule),
          Tab(text: l.tabDocuments),
          Tab(text: l.tabMessages),
          ...
          Wrap(
            ...
            children: [
              CircleAvatar(
                ...
                child: Text(initials(client.fullName), style: t.titleMedium?.copyWith(color: CorocColors.navy800)),
              ),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
            ...
            children: [
              ...
              if (active && (user?.can('payments.register') ?? false))
                GoldButton(
                  ...
                  onPressed: () async {
                    final r = await showPaymentSheet(
                      context,
                      ref,
                      loanId: loan!.id,
                      currency: loan!.terms.currency,
                      suggested: loan!.summary.next?.outstanding ?? loan!.summary.balance,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            FittedBox(
                              ...
                              child: Text(
                                k.$2,
                                style: t.headlineSmall?.copyWith(fontFamily: 'Inter', fontWeight: FontWeight.w400),
                              ),
                            ),
                          ],
                        ),
            ...
            final terms = SectionCard(
              ...
              child: Column(
                children: [
                  ...
                  KeyValue(
                    l.termsRate,
                    loan.terms.method == 'french' ? l.ratePerPeriod(percent(double.parse(loan.terms.rate), context.lang)) : l.rateOnTotal(percent(double.parse(loan.terms.rate), context.lang)),
                  ),
                ...
                for (final e in list.reversed) ...[
                  ListTile(
                    ...
                    trailing: Row(
                      ...
                      children: [
                        Text(
                          Money.format(e.amount, loan.terms.currency),
                          style: t.titleSmall?.copyWith(fontFamily: 'Inter', decoration: e.reversedBy != null ? TextDecoration.lineThrough : null),
                        ),
                        ...
                        if (canReverse && e.type == 'payment' && e.reversedBy == null) IconButton(tooltip: l.actionReverse, icon: const Icon(Icons.undo), onPressed: () => _reverse(context, ref, e)),
                      ],
                    ),
                  ),
                  const Divider(),
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              controller: reason,
              autofocus: true,
              decoration: corocInput(context, label: l.reason),
              maxLines: 2,
            ),
          ],
        ),
