...
class ClientFields extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Widget pair(Widget a, Widget b) => LayoutBuilder(builder: (context, c) {
          if (c.maxWidth < 560) return Column(children: [a, const SizedBox(height: CorocSpace.md), b]);
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      ...
      gap,
      Wrap(spacing: CorocSpace.md, runSpacing: CorocSpace.md, crossAxisAlignment: WrapCrossAlignment.center, children: [
        Text(l.fieldLanguage),
        SegmentedButton<String>(
          showSelectedIcon: false,
          segments: [for (final c in ['es', 'pt-BR', 'en']) ButtonSegment(value: c, label: Text(languageName(l, c)))],
      ...
      if (canPickCollector) ...[
        gap,
        _CollectorPicker(data: data, onChanged: onChanged),
      ],
      gap,
      ExpansionTile(
...
Future<Client?> showEditClient(BuildContext context, WidgetRef ref, Client client) {
  return showDialog<Client>(context: context, builder: (_) => Dialog(child: ConstrainedBox(constraints: const BoxConstraints(maxWidth: 720), child: _EditClient(client: client))));
}
      ...
      child: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          ...
          if (_error != null) ...[
            ...
            Text(errorText(context, _error!), style: TextStyle(color: Theme.of(context).colorScheme.error)),
          ],
          const SizedBox(height: CorocSpace.lg),
