...
final messagesProvider = FutureProvider.autoDispose.family<MessagePage, MessageQuery>((ref, q) => ref.watch(apiProvider).messages(
      status: q.statuses.isEmpty ? const [] : q.statuses.split(','),
      clientId: q.clientId,
      limit: 100,
    ));
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            if (ruleLine != null) ...[
              ...
              Text(ruleLine, style: t.bodySmall?.copyWith(color: m.status == 'blocked' ? Theme.of(context).colorScheme.error : null)),
            ],
      ...
      content: SizedBox(
        ...
        child: SingleChildScrollView(
          child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, mainAxisSize: MainAxisSize.min, children: [
            ...
            if (m.via != null) KeyValue(l.msgVia, m.via == 'cloud_api' ? l.msgViaCloud : m.via == 'email' ? l.channelEmail : l.msgViaAssisted),
          ]),
        ),
      ),
